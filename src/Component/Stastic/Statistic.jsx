...
const Statistic = () => {
                    ...
                    useEffect(() =>{
                                        document.title="Statistic | Gadget & Gear"
                                       },[])
                    return (
                                        <div>
                                       <div className='container mx-auto min-h-[calc(100vh-203px)]'>
                                        ...
                                        <h1 className='lg:text-6xl md:text-3xl text-2xl  w-11/12 xl:w-10/12 text-center mx-auto text-white font-bold'>Statistics</h1>
